...
<head>
    ...
    <meta name="description" content="Cartering Page">
    <meta name="author" content="Paul Northrup and Everardo Mendoza">

    <title>Carter's Catering Catering Page</title>
...
<!--Navigation Bar Start-->    
    ...
    <div class="col-sm-9">
        ...
        <form method="post" id="catering_form" name="catering_form"  action="catering.php">
<!--Personal Info Tabs-->          
          <div>
...
<section class="container">
  <div class="col-sm-3 text-center">
    <p id="VI">C<br>A<br>T<br>E<br>R<br>I<br>N<br>G</p>
  </div>

<!--Order System HTML / Food Item Table-->    
      <div class="col-sm-9">
            <table>
              <tr>
                <th>PRODUCT</th>
